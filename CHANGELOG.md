...
- Show taxonomy 'openpub-show-on' in rest
...
- Do not use post_title when trying to retrieve an item by slug, set post_name on draft save.

## Version [2.3.6]

## Refactor

- Use elasticpress ^3.0 or ^4.0.

## Version [2.3.5]

## Refactor

- Use post_title when trying to retrieve an item by slug.
